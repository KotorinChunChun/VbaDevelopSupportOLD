VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} FormDeclareSourceGenerate 
   Caption         =   "UserForm2"
   ClientHeight    =   3015
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   4560
   OleObjectBlob   =   "FormDeclareSourceGenerate.frm.frx":0000
   StartUpPosition =   1  'オーナー フォームの中央
End
Attribute VB_Name = "FormDeclareSourceGenerate"
...
'    On Error Resume Next
    TextBox2.Text = GetDeclareCodeByText(TextBox1.Text, True, True, 10)
'    On Error GoTo 0
End Sub
